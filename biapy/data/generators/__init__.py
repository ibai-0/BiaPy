...
def create_train_val_augmentors(
    ...
    if cfg.PROBLEM.TYPE == "CLASSIFICATION" or (
        ...
        dic = dict(
            ...
            dropout=cfg.AUGMENTOR.DROPOUT,
            drop_range=cfg.AUGMENTOR.DROP_RANGE,
            superpixel_mask=cfg.AUGMENTOR.SUPERPIXEL_MASK,
            spm_range=cfg.AUGMENTOR.SPM_RANGE,
            spm_is_3d=cfg.AUGMENTOR.SPM_3D,
            spm_mask_fraction=cfg.AUGMENTOR.SPM_MASK_FRACTION,
            spm_cval=cfg.AUGMENTOR.SPM_CVAL,
            spm_apply_to_mask=cfg.AUGMENTOR.SPM_APPLY_TO_MASK,
            spm_compactness=cfg.AUGMENTOR.SP_COMPACTNESS,
            spm_sigma=cfg.AUGMENTOR.SP_SIGMA,
